namespace MMC_PlayList
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.btnSave.Text = "Save this Playlist";
            ...
            this.dlgSave.Filter = "Playlists (*.m3u)|*.m3u|All Files|*.*";
            this.dlgSave.Title = "Save the PlayList";
            // 
            // dlgOpen
            // 
            this.dlgOpen.AddExtension = false;
            this.dlgOpen.Filter = "Alle Files|*.*|MP3\'s|*.mp3";
            this.dlgOpen.Multiselect = true;
            this.dlgOpen.Title = "Add Files to the Playlist";
            // 
            // Form1
            // 
